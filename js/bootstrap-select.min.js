...
! function (b) {
    ...
    a.prototype = {
        ...
        createDropdown: function () {
            ...
            var e = '<div class="btn-group bootstrap-select jumbotron-dropup' + c + d + '"><div class="selectpicker" data-toggle="dropdown"' + i + '><span class="filter-option pull-left"></span></div><div class="dropdown-menu open">' + h + g + f + '<ul class="dropdown-menu inner selectpicker" role="menu"></ul></div></div>';
            return b(e)
        },
        createView: function () {
